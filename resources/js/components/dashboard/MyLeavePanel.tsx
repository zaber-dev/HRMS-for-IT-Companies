...
export function MyLeavePanel({ approved_days, pending_count, most_recent }: Props) {
    return (
        <div className="rounded-lg border border-border bg-card p-6">
            ...
            <div className="mb-4 grid grid-cols-2 gap-3">
                <div className="rounded-md border border-border bg-background p-3 text-center">
                    ...
                    <div className="mt-1 text-xs text-muted-foreground">Approved Days (This Year)</div>
                </div>
                <Link
                    href={leaveIndex.url()}
                ...
                >
                    ...
                    <div className="mt-1 text-xs text-muted-foreground">Pending Requests</div>
                </Link>
            </div>
