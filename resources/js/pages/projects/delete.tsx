...
import { index, show, destroy } from '@/actions/App/Http/Controllers/Projects/ProjectController';
    ...
    return (
        <>
            ...
            <div className="space-y-6">
                <Heading title="Delete Project" description="This action cannot be undone." />

                <div className="rounded-lg border border-destructive/50 bg-destructive/5 p-6 space-y-4 max-w-lg">
                    <p className="text-sm text-muted-foreground">
                        You are about to permanently delete the following project:
                    </p>
                    ...
                    <div className="space-y-2">
                        ...
                        <div>
                            <p className="text-xs font-medium text-muted-foreground uppercase tracking-wide">Active Assignments</p>
                    ...
                    <p className="text-sm text-muted-foreground">
                        All assignments will be removed and affected employees' bench status will be recalculated.
    </p>
                </div>

                <div className="flex items-center gap-4">
                    <Button variant="destructive" disabled={processing} onClick={handleConfirm}>
                        Confirm Delete
                    </Button>
